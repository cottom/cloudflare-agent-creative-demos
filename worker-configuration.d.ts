/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6b3ee6de002d3e03d59018601539df34)
...
interface __BaseEnv_Env {
	...
	PUBLIC_ORIGIN: "https://cloudflare-creative-agent-demos.cottom-zw.workers.dev";
	PPT_PROJECT: DurableObjectNamespace<import("./src/worker/index").PptProject>;
	CANVAS_PROJECT: DurableObjectNamespace<import("./src/worker/index").CanvasProject>;
	STUDIO_AGENT: DurableObjectNamespace<import("./src/worker/index").StudioAgent>;
	TENANT: DurableObjectNamespace<import("./src/worker/index").Tenant>;
	PPT_BUILD_WORKFLOW: Workflow<Parameters<import("./src/worker/index").PptBuildWorkflow['run']>[0]['payload']>;
	CANVAS_VARIANTS_WORKFLOW: Workflow<Parameters<import("./src/worker/index").CanvasVariantsWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "PptProject" | "CanvasProject" | "StudioAgent" | "Tenant";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LLM_MODEL" | "IMAGE_MODEL" | "PUBLIC_ORIGIN">> {}
}
